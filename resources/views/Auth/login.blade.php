    ...
    align-items: center;">
                                    ...
                                    <div class="form-group" style="max-width: 300px; width: 100%">
                                        ...
                                        @if (Session::has('email'))
                                            <div  style="font-size: 13px" class="alert-danger">{!! Session::get('email') !!}</div>
                                        @endif
                                        <input name="email" type="email"  class="form-control input1" aria-describedby="emailHelp" placeholder="Enter email" value="{{ old('email') }}">
