...
//////////////////////////////////////////////////////////////////////////////
        $partner = partner::all();
        $partner1 = partner::where('line',  '=', 'line1' )->orderBy('created_at','DESC')->limit(6)->get();

        $partner2 = partner::where('line' , '=' , 'line2')->orderBy('created_at','DESC')->limit(6)->get();
        $partner3 = partner::where('line' , '=' , 'line3')->orderBy('created_at','DESC')->get();
